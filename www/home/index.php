        ...
        <header class="header" id="header">
            <nav class="nav container">
                <a href="#" class="nav__logo">
                    <i class='bx bxs-watch nav__logo-icon'></i> Minipura Gems
                </a>
            ...
            <section class="home" id="home">
                <div class="home__container container grid">
                    <div class="home__img-bg">
                        <img src="assets/img/gembg.png" alt="" class="home__img">
                    </div>
                    ...
                    <div class="home__data">
                        <h1 class="home__title"> Minipura  <br> Gem & Jewelry</h1>
                        <p class="home__description">
                        Minipura Gem and Jewelry Online Store: Your destination for exquisite gemstones and stunning jewelry pieces !
                        </p>
                        ...
                        <div class="home__btns">
                            ...
                            <button class="button home__button">Gem & Jewelry</button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="featured section container" id="featured">
                ...
                <div class="featured__container grid">
                    <article class="featured__card">
                        ...
                        <img src="assets/img/download-removebg-preview (2).png" alt="" class="featured__img">

                        <div class="featured__data">
                            <h3 class="featured__title">Jazzmaster</h3>
                            <span class="featured__price">Rs.1050</span>
                        </div>
                    ...
                    <article class="featured__card">
                        ...
                        <img src="assets/img/images__1_-removebg-preview (2).png" alt="" class="featured__img">

                        <div class="featured__data">
                            <h3 class="featured__title">Ingersoll</h3>
                            <span class="featured__price">Rs.2500</span>
                        </div>
                    ...
                    <article class="featured__card">
                        ...
                        <img src="assets/img/images-removebg-preview (1).png" alt="" class="featured__img">

                        <div class="featured__data">
                            <h3 class="featured__title">Rose gold</h3>
                            <span class="featured__price">Rs.8900</span>
                        </div>
                ...
                <div class="story__container grid">
                    <div class="story__data">
                        ...
                        <h1 class="story__title">
                            Inspirational Juwelery of <br> this year
                        </h1>
    
                        <p class="story__description">
                            The latest and modern Juwelery of this year, is available in various 
                    ...
                    <div class="story__images">
                        <img src="assets/img/images (2).jpeg" alt="" class="story__img">
                    ...
                    <div class="swiper testimonial-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="testimonial__card swiper-slide">
                                ...
                                <div class="testimonial__perfil">
                                    <img src="assets/img/Boho-Style-Jewelry-Gems-Necklace-Rings-Hoop-Earrings.jpg" alt="" class="testimonial__perfil-img">
                    ...
                    <div class="swiper new-swiper">
                        <div class="swiper-wrapper">
                            <article class="new__card swiper-slide">
                                ...
                                <img src="assets/img/png-transparent-jewellery-costume-jewelry-necklace-jewelry-miscellaneous-gemstone-diamond-thumbnail-removebg-preview.png" alt="" class="new__img">
                            ...
                            <article class="new__card swiper-slide">
                                ...
                                <img src="assets/img/images__4_-removebg-preview.png" alt="" class="new__img">
                            ...
                            <article class="new__card swiper-slide">
                                ...
                                <img src="assets/img/images__1_-removebg-preview (2).png" alt="" class="new__img">
